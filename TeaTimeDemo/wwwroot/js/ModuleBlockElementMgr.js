...
class ModuleBlockElementMgr {
    ...
    static ModuleBlockID_Prefix = "MB_";
...
class ModuleDataFetcherMgr {
    ...
    static getAllTableGridTr(TargetModuleBlock) {
        if (!ModuleBlockElementMgr.checkIsModuleBlock(TargetModuleBlock)) {
            return null;
        }
        var allModuleBlocks = TargetModuleBlock.querySelectorAll(
            `:scope > .${ModuleBlockElementMgr.ModuleBlock_innerName} > .${ModuleBlockElementMgr.TableGridName} > tr,
             :scope > .${ModuleBlockElementMgr.ModuleBlock_innerName} > .${ModuleBlockElementMgr.TableGridName} > tbody > tr`
        );
